-- Mettre à jour save_current_standings_as_previous pour archiver les race_results
...
-- Mettre à jour restore_standings_by_timestamp pour restaurer les race_results
...
-- Mettre à jour delete_standings_save pour supprimer aussi les résultats archivés
