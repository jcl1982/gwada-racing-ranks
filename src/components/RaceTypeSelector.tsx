...
interface RaceTypeSelectorProps {
  selectedType: 'montagne' | 'rallye' | 'c2r2';
  onTypeChange: (type: 'montagne' | 'rallye' | 'c2r2') => void;
}
  ...
  return (
    <Card className="card-glass">
      <CardContent className="p-4">
        ...
        <RadioGroup
          value={selectedType}
          onValueChange={(value) => onTypeChange(value as 'montagne' | 'rallye' | 'c2r2')}
        ...
        >
          ...
          <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-orange-50 transition-colors">
            <RadioGroupItem value="c2r2" id="c2r2" />
            <Label htmlFor="c2r2" className="flex items-center gap-2 cursor-pointer">
              <Car className="w-5 h-5 text-orange-600" />
              <span>Trophée C2 R2</span>
            </Label>
          </div>
        </RadioGroup>
      </CardContent>
