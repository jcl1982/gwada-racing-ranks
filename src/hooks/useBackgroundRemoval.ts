...
export const useBackgroundRemoval = () => {
  ...
  const processImageUrl = useCallback(async (imageUrl: string, imageKey: string) => {
    if (processedImages[imageKey]) {
      return processedImages[imageKey];
    }
    ...
    try {
      ...
      setProcessedImages(prev => ({ ...prev, [imageKey]: processedUrl }));
  ...
  return { processImageUrl, isProcessing, processedImages };
};
